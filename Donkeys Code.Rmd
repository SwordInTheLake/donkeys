...
h <- hist(actual_over_predicted, breaks = 4, main = "Distribution of relative errors, actual/predicted", ylim=c(0,55))
...
plot_histogram <- function(list, title, subdivide){
  if (subdivide){
    h <- hist(list, main=title, breaks = 16, ylim=c(0,40))
  }
  else{
    h <- hist(list, main=title, ylim=c(0,40))
  }
