...
* Note that the values obtained are significantly different. This might pose an issue for reproducibility.
* b0_given = -107
* b1_given = 19.91
* b2_given = 7.712
...
* We are unable to perform cross-validation on authors' model because we cannot recover ols values
* Cross-validation shows that our model performs even better on other folds. 

# ToDo: Sensitivity Analysis using betas, define how much output changes with a given change in input
